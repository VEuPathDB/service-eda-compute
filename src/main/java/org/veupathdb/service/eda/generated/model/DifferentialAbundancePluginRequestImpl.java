...
public class DifferentialAbundancePluginRequestImpl implements DifferentialAbundancePluginRequest {
  ...
  @JsonProperty("config")
  private DifferentialAbundanceComputeConfig config;
  ...
  @JsonProperty("config")
  public DifferentialAbundanceComputeConfig getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(DifferentialAbundanceComputeConfig config) {
    this.config = config;
  }
