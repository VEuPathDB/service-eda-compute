...
@JsonDeserialize(
    as = APILongitudeVariableImpl.class
)
public interface APILongitudeVariable extends APIVariableWithValues {
  APIVariableType _DISCRIMINATOR_TYPE_NAME = APIVariableType.LONGITUDE;
