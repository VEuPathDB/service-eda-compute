...
public class CorrelationAssayAssayPluginRequestImpl implements CorrelationAssayAssayPluginRequest {
  ...
  @JsonProperty("config")
  private Correlation2Collections config;
  ...
  @JsonProperty("config")
  public Correlation2Collections getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(Correlation2Collections config) {
    this.config = config;
  }
