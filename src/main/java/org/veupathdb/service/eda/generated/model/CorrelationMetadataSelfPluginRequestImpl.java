...
public class CorrelationMetadataSelfPluginRequestImpl implements CorrelationMetadataSelfPluginRequest {
  ...
  @JsonProperty("config")
  private CorrelationComputeConfig config;
  ...
  @JsonProperty("config")
  public CorrelationComputeConfig getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(CorrelationComputeConfig config) {
    this.config = config;
  }
