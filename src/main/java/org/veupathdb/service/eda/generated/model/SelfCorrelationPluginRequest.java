...
@JsonDeserialize(
    as = SelfCorrelationPluginRequestImpl.class
)
public interface SelfCorrelationPluginRequest extends ComputeRequestBase {
  ...
  @JsonProperty("config")
  SelfCorrelationConfig getConfig();

  @JsonProperty("config")
  void setConfig(SelfCorrelationConfig config);
