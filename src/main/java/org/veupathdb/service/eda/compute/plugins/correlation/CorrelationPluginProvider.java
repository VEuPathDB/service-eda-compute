...
public class CorrelationPluginProvider implements PluginProvider<CorrelationPluginRequest, CorrelationConfig> {
  @NotNull
  @Override
  ...
  @NotNull
  @Override
  public CorrelationPlugin createPlugin(@NotNull PluginContext<CorrelationPluginRequest, CorrelationConfig> context) {
